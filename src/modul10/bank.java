    ...
    public static void main (String args []) {
        ...
        try{
            do{
                ...
                counter+=1; //meghitung kesempatan login
                ...
                if (pin==1234)//cek pin
                    ...
                    switch (choice) {
                        ...
                        JOptionPane.YES_NO_CANCEL_OPTION, 3); //konfirmasi transaksi lain
                            if (z==0)
                                break;
                            else
                        ...
                        strl = JOptionPane.showInputDialog(null,"Masukkan jumlah penyetoran: " ); //menabung
                        ...
                        strl = JOptionPane.showInputDialog(null,"Masukkan jumlah penarikan : " ); //pengambilan 
